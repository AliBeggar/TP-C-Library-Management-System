...
#define UP    72  // Arrow Up
#define DOWN  80  // Arrow Down
...
void ass_prio(loan * p , char prio);        // Sets loan priority
char priority(loan * p);                     // Gets loan priority
...
void remove_br_title(brptr *head , char string[]); // Removes borrower by name
